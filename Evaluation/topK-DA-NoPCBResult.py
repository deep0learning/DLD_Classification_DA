...
def getInformation(file):
    ...
    for e, tr_acc, g_l, df_l, src_tst_acc, src_tst_fsc, tar_tst_acc, tar_tst_fsc in zip(epoch,
                                                                                        training_accuracy,
                                                                                        g_loss,
                                                                                        df_loss,
                                                                                        source_test_accuracy,
        ...
        summarized_list.append(
            [e, tr_acc, g_l, df_l, src_tst_acc, src_tst_fsc, tar_tst_acc, tar_tst_fsc])
...
def main():
    top_k = 20
    file_dir = 'D:/DLD_Classification_DomainAdaptation_Experimental_Results/Self-Comparison/self-compare/nocpb/'
