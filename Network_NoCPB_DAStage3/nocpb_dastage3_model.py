...
import nocpb_dastage3_utils as utils
import evaluation_function as eval
import time


class nocpb_dastage3_model(object):
    ...
    def build_model(self):
        ...
        self.source_stage3_dis = self.discriminator(self.source_stage3_features, scope_name='stage3_discriminator',
                                                    is_training=self.is_training, reuse=False)
        self.target_stage3_dis = self.discriminator(self.target_stage3_features, scope_name='stage3_discriminator',
        ...
        with tf.variable_scope('loss'):
            ...
            self.g_loss = self.target_stage3_gloss
        ...
        for e in range(1, self.eps + 1):
            for itr in range(self.itr_epoch):
                ...
                _source_training_acc, _g_loss, _d_loss_feature = self.sess.run(
                    [self.accuracy_source, self.g_loss, self.d_loss_feature],
