...
import nocpb_dastage2_utils as utils
import time


class nocpb_dastage2_model(object):
    ...
    def build_model(self):
        ...
        self.source_stage2_dis = self.discriminator_F(self.source_stage2_features, scope_name='stage2_discriminator',
                                                      is_training=self.is_training, reuse=False)
        self.target_stage2_dis = self.discriminator_F(self.target_stage2_features, scope_name='stage2_discriminator',
        ...
        with tf.variable_scope('loss'):
            ...
            self.g_loss = self.target_stage2_gloss + self.target_label_gloss
